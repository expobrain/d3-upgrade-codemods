...
export default function transformer(file, api) {
  ...
  root
    ...
    .replaceWith((path) => {
      const callee = j.memberExpression(path.node.object.callee.object, j.identifier('timeParse'))
      const callExpression = j.callExpression(callee, path.node.object.arguments)
